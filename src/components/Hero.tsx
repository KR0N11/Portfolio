      ...
      <div className="relative z-10 w-full px-[4%] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center pt-[68px]">
        ...
        >
          <div className="relative">
            ...
            {/* Photo — no border, fades on all edges */}
            <div className="relative w-[280px] h-[370px] sm:w-[320px] sm:h-[420px] md:w-[380px] md:h-[500px] overflow-hidden">
              <Image
                src="/image/me.jpg"
                alt="Ping Chun Lui"
                fill
                ...
                style={{
                  maskImage:
                    "radial-gradient(ellipse 85% 80% at 50% 40%, black 40%, transparent 100%)",
                  WebkitMaskImage:
                    "radial-gradient(ellipse 85% 80% at 50% 40%, black 40%, transparent 100%)",
                }}
              />
